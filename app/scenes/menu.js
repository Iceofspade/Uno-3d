...
exports.app = {
    ...
    scene: (engine, canvas) => {
        ...
        let menuMusic = new BABYLON.Sound("Menue music", `../assets/audio/music/Evence - Falling Ninety9Lives release.mp3`, scene, null, { autoplay: true, volume: gameSettings_json_1.default.volumeLevel * 0.6, loop: true });
        ...
        musicVolume.slider.value = gameSettings_json_1.default.volumeLevel * 100;
        musicVolume.SliderText.text = `${musicVolume.slider.value}`;
        musicVolume.slider.onValueChangedObservable.add(() => {
            musicVolume.SliderText.text = `${musicVolume.slider.value}`;
            gameSettings_json_1.default.volumeLevel = musicVolume.slider.value / 100;
        ...
        defaultSetting.onPointerDownObservable.add(() => {
            ...
            gameSettings_json_1.default.volumeLevel = 0.5;
            ...
            optionsBoxContainer.isVisible = false;
            fs_1.default.writeFile(path_1.default.join(__dirname, `gameSettings.json`), JSON.stringify(gameSettings_json_1.default, null, 4), function (err) {
                if (err)
                    throw err;
            });
        });
        ...
        saveButton.onPointerDownObservable.add(() => {
            gameSettings_json_1.default.botCount = botCount.slider.value;
            gameSettings_json_1.default.startingCardCount = startingHandSize.slider.value;
            gameSettings_json_1.default.volumeLevel = musicVolume.slider.value / 100;
            gameSettings_json_1.default.playerName = nameInput.text;
            optionsBoxContainer.isVisible = false;
            fs_1.default.writeFile(path_1.default.join(__dirname, `gameSettings.json`), JSON.stringify(gameSettings_json_1.default, null, 4), function (err) {
                if (err)
                    throw err;
